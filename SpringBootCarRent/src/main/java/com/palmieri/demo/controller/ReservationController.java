...
public class ReservationController
{
	...
	public ResponseEntity<Reservation> insertReservation(@Valid @RequestBody Reservation reservation, BindingResult result)
	...
	public ResponseEntity<?> deleteReservation(@PathVariable("id") int id, Model model, HttpServletRequest request)
